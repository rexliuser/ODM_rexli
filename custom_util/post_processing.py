...
def post_processing(paths, args):
    ...
    name = f"{paths.projectname}_{now.strftime('%Y%m%d_%H%M%S')}.glb"
    ...
    path_glb = os.path.join(paths.path_exports,f'{paths.projectname}.glb')
    ...
    if args.server:
        ...
        src = os.path.join(paths.path_exports,f'{paths.projectname}.glb')
